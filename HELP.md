...
* The original package name 'hello.YH-spring-boot-Core-Principles-and-Applications' is invalid and this project uses 'hello.YHspringbootCorePrinciplesandApplications' instead.
